    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_year', models.CharField(blank=True, choices=[('Year 1', 'Year 1'), ('Year 2', 'Year 2'), ('Year 3', 'Year 3'), ('Year 4', 'Year 4'), ('Year 5', 'Year 5'), ('Year 6', 'Year 6')], help_text='Grade or class year for students', max_length=50, null=True)),
